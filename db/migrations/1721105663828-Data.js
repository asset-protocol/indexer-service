module.exports = class Data1721105663828 {
    name = 'Data1721105663828'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "asset_hub" ("id" character varying NOT NULL, "management" text, "admin" text, "name" text, "is_open" boolean, "contract_uri" text, "token_collect_module" text, "fee_collect_module" text, "nft_gated_module" text, "create_asset_module" text, "timestamp" numeric, "implementation" text, "version" text, "hash" text, "metadata" jsonb, CONSTRAINT "PK_99771a62f48504f4154931b5819" PRIMARY KEY ("id"))`)
        await db.query(`CREATE UNIQUE INDEX "IDX_02047cd2770a4aca3144fdc342" ON "asset_hub" ("name") `)
        await db.query(`CREATE INDEX "IDX_50c2ba3be1eebdd94b762a7661" ON "asset_hub" ("is_open") `)
        ...
        await db.query(`CREATE TABLE "curation" ("id" character varying NOT NULL, "biz_id" text NOT NULL, "contract" text, "token_id" numeric, "token_uri" text, "status" integer, "expiry" numeric, "hash" text, "timestamp" numeric, "last_updated_at" numeric, "name" text, "description" text, "image" text, "banner_image" text, "external_url" text, "background_color" text, "attributes" jsonb, "metadata" jsonb, "hub_id" character varying, CONSTRAINT "PK_de0e4d1c645b4bc2e9a26b9a3f1" PRIMARY KEY ("id"))`)
        await db.query(`CREATE UNIQUE INDEX "IDX_1eb72187a37b463874fd16ad88" ON "curation" ("biz_id") `)
        await db.query(`CREATE INDEX "IDX_1c0695ede32bc02b4a6a966ea2" ON "curation" ("hub_id") `)
        ...
        await db.query(`CREATE TABLE "curation_asset" ("id" character varying NOT NULL, "status" integer, "expiry" numeric, "timestamp" numeric, "approve_at" numeric, "hash" text, "curation_id" character varying, "asset_id" character varying, CONSTRAINT "PK_deb7c8f85e292c8e61759d22980" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "asset" ("id" character varying NOT NULL, "biz_id" text NOT NULL, "asset_id" numeric NOT NULL, "publisher" text, "content_uri" text, "timestamp" numeric, "hash" text, "last_updated_at" numeric, "query1" text, "query2" text, "name" text, "type" text, "image" text, "description" text, "metadata" jsonb, "content" text, "attributes" jsonb, "collect_module" text, "collect_module_init_data" text, "collect_nft" text, "collect_count" numeric, "gated_module" text, "gated_module_init_data" text, "hub_id" character varying, CONSTRAINT "PK_1209d107fe21482beaea51b745e" PRIMARY KEY ("id"))`)
        await db.query(`CREATE UNIQUE INDEX "IDX_60460967c521a766879849fae2" ON "asset" ("biz_id") `)
        ...
        await db.query(`CREATE INDEX "IDX_99771a62f48504f4154931b581" ON "asset" ("hub_id") `)
        ...
        await db.query(`CREATE TABLE "hub_manager" ("id" character varying NOT NULL, "timestamp" numeric, "global_module" text, "hub_creator_nft" text, "curation" text, "moudles" jsonb, CONSTRAINT "PK_9c07121c4e2c56ed6dc59bfd7d1" PRIMARY KEY ("id"))`)
        ...
        await db.query(`ALTER TABLE "curation" ADD CONSTRAINT "FK_1c0695ede32bc02b4a6a966ea28" FOREIGN KEY ("hub_id") REFERENCES "asset_hub"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        ...
        await db.query(`ALTER TABLE "asset" ADD CONSTRAINT "FK_99771a62f48504f4154931b5819" FOREIGN KEY ("hub_id") REFERENCES "asset_hub"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_50c2ba3be1eebdd94b762a7661"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_1c0695ede32bc02b4a6a966ea2"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_60460967c521a766879849fae2"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_99771a62f48504f4154931b581"`)
        ...
        await db.query(`ALTER TABLE "curation" DROP CONSTRAINT "FK_1c0695ede32bc02b4a6a966ea28"`)
        ...
        await db.query(`ALTER TABLE "asset" DROP CONSTRAINT "FK_99771a62f48504f4154931b5819"`)
