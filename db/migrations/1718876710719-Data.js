module.exports = class Data1718876710719 {
    name = 'Data1718876710719'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "curation" ("id" character varying NOT NULL, "token_uri" text, "publisher" text, "status" integer, "expiry" numeric, "hash" text, "timestamp" numeric, "last_updated_at" numeric, "name" text, "description" text, "image" text, "banner_image" text, "external_url" text, "background_color" text, "attributes" jsonb, "metadata" jsonb, CONSTRAINT "PK_de0e4d1c645b4bc2e9a26b9a3f1" PRIMARY KEY ("id"))`)
