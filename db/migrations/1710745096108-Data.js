module.exports = class Data1710745096108 {
    name = 'Data1710745096108'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "asset_hub" ("id" character varying NOT NULL, "admin" text, "name" text, "fee_collect_module" text, "nft_gated_module" text, "create_asset_module" text, "timestamp" numeric, "implementation" text, "version" integer, "hash" text, CONSTRAINT "PK_99771a62f48504f4154931b5819" PRIMARY KEY ("id"))`)
