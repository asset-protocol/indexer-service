module.exports = class Data1718846821207 {
    name = 'Data1718846821207'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "asset" ("id" character varying NOT NULL, "biz_id" text NOT NULL, "asset_id" numeric NOT NULL, "hub" text NOT NULL, "hub_name" text, "publisher" text, "content_uri" text, "timestamp" numeric, "hash" text, "last_updated_at" numeric, "query1" text, "query2" text, "name" text, "type" text, "image" text, "description" text, "metadata" jsonb, "content" text, "attributes" jsonb, "collect_module" text, "collect_module_init_data" text, "collect_nft" text, "collect_count" numeric, "gated_module" text, "gated_module_init_data" text, CONSTRAINT "PK_1209d107fe21482beaea51b745e" PRIMARY KEY ("id"))`)
