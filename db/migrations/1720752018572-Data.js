module.exports = class Data1720752018572 {
    name = 'Data1720752018572'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "asset_hub" ("id" character varying NOT NULL, "management" text, "admin" text, "name" text, "is_open" boolean, "token_collect_module" text, "fee_collect_module" text, "nft_gated_module" text, "create_asset_module" text, "timestamp" numeric, "implementation" text, "version" text, "hash" text, "metadata" jsonb, CONSTRAINT "PK_99771a62f48504f4154931b5819" PRIMARY KEY ("id"))`)
