module.exports = class Data1715225788688 {
    name = 'Data1715225788688'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "asset" ("id" character varying NOT NULL, "asset_id" numeric, "publisher" text, "content_uri" text, "timestamp" numeric, "hash" text, "last_updated_at" numeric, "query1" text, "query2" text, "name" text, "type" text, "image" text, "description" text, "properties" jsonb, "metadata" jsonb, "content" text, "collect_module" text, "collect_module_init_data" text, "collect_nft" text, "collect_count" numeric, "gated_module" text, "gated_module_init_data" text, "hub_id" character varying, CONSTRAINT "PK_1209d107fe21482beaea51b745e" PRIMARY KEY ("id"))`)
